...
ggplot(data = plotdata_wide) + 
  ...
  labs(x = 'Life expectancy',
       y = '',
       title = 'Change in Life Expectancy (1952 to 2007)',
       subtitle = 'ordered by net change in life expectancy',
       caption = '**source:** gapminder.org | **data viz:** @nicoambrosis') +
  theme(plot.caption = ggtext::element_markdown())

ggsave("Making dumbell charts.png", dpi = 300, width = 19, height = 10, units = "cm")
